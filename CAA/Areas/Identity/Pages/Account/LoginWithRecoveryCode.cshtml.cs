...
namespace CAA.Areas.Identity.Pages.Account
{
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in releases futuras.
            /// </summary>
            [BindProperty]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                _logger.LogWarning("Código de recuperação inválido informado para o usuário com ID '{UserId}' ", user.Id);
